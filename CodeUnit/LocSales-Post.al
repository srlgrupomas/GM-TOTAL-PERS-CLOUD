...
#pragma warning restore AA0470
    ...
    begin
        ...
        RunDefaultCheckSalesElectronicDocument(SalesHeader);
...
#pragma warning restore AL0432
    ...
    begin
        ...
        //Comentamos para no enviar a afip
...
#pragma warning restore AA0005
        ...
        if InvoiceRoundingAmount <> 0 then begin
            ...
            if SalesHeader."Prices Including VAT" then
                ...
                SalesLine.Validate(
                  ...
                  Round(
                    InvoiceRoundingAmount /
                    (1 + (1 - GetVatBaseDiscountPct(SalesHeader) / 100) * SalesLine."VAT %" / 100),
                    Currency."Amount Rounding Precision"));
    ...
    begin
        ...
        SalesLine."VAT Base Amount" :=
          Round(
            SalesLine.Amount * (1 - GetVatBaseDiscountPct(SalesHeader) / 100), Currency."Amount Rounding Precision");
    end;

    procedure GetVatBaseDiscountPct(SalesHeader: Record "Sales Header") Result: Decimal
    begin
