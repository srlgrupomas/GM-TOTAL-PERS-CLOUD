/// <summary>
///  File Description : MEM Copy of Localization Argentina report: VAT Sales Book (report 34006499 "GMLocVAT Sales Book F(V)NC(C)") 
/// </summary>
/// <remarks>
...
/// </remarks>
report 80901 "PersVAT Sales Book F(V)NC(C)"
{

    DefaultRenderingLayout = "BssiMEMVATSalesBook.rdlc";
    Caption = 'MEM VAT Sales Book';
    ApplicationArea = All;
        ...
        dataitem(DimensionValue; "Dimension Value")
        {
            ...
            dataitem(Cabecera; "Integer")
            {
                    ...
                    dataitem(AFacturas; "Integer")
                    {
                        ...
                        begin
                            ...
                            if not recTempDatos.FindFirst then begin
                                ...
                                recTempDatos.GMLocPostingdate := Facturas."Posting Date";
                ...
                dataitem(Facturas2; "Service Invoice Header")
                {
                    ...
                    dataitem(AFacturas2; "Integer")
                    {
                        ...
                        begin
                            ...
                            if not recTempDatos.FindFirst then begin
                                recTempDatos.GMLocKey := keyTempDatos;
                                recTempDatos.GMLocPostingdate := Facturas2."Posting Date";
                                ...
                                if Facturas2."GMLocAFIP Voucher Type" = '63' then
                                    RecTempDatos.GMLoctipodocumento := 'Liquidacion de Ventas';

                                if Facturas2."GMLocAFIP Voucher Type" = '66' then
                                    RecTempDatos.GMLoctipodocumento := 'Despacho Importación';
                ...
                dataitem(NotasDeCredito; "Purch. Cr. Memo Hdr.")
                {
                    ...
                    dataitem(ACreditos; "Integer")
                    {
                        ...
                        begin
                            ...
                            if not recTempDatos.FindFirst then begin
                                recTempDatos.GMLocKey := keyTempDatos;
                                recTempDatos.GMLocPostingdate := NotasDeCredito."Posting Date";
                ...
                dataitem(Totales; "Integer")
                {
                    ...
                    column(GTdecIVA105; GTdecIVA105)
                    {
                    }
                    column(GTdecIVA21; GTdecIVA21)
                    {
                    }
                    column(GTdecIVA27; GTdecIVA27)
                    {
                    }
                    column(GTdecIVA25; GTdecIVA25)
                    {
                    }
            ...
            begin
                ...
                Clear(GTdecIVA27);
                Clear(GTdecIVA27c);
                Clear(GTotalBaseExcento);
                Clear(GTotalBaseExcentoC);
                Clear(GTotalBaseGravado);
                Clear(GTotalBaseGravadoC);
                Clear(GTotalBaseNoGravado);
                Clear(GTotalBaseNoGravadoC);
                Clear(GTotalDifRed);
                Clear(GTotalFactura);
                Clear(GTotalFacturaC);
                Clear(GTotalIGA);
                Clear(GTotalIGAC);
                Clear(GTotalIIB);
                Clear(GTotalIIBC);
                ...
                Clear(GTotalIPer);
                Clear(GTotalIPerC);
                Clear(GTotalBaseTotal);
                Clear(GTotalBaseTotalC);
                Clear(BssiPrint);
            end;
    ...
    rendering
    {
        layout("BssiMEMVATSalesBook.rdlc")
        {
            Type = RDLC;
            LayoutFile = './Layout/MEM/BssiMEMVATSalesBook.rdl';
            Caption = 'MEM Vat Sales Book';
        }
        layout("BssiMEMVATPurchaseBookEntity.rdlc")
        {
            Type = RDLC;
            LayoutFile = './Layout/MEM/BssiMEMVATSalesBookEntity.rdl';
            Caption = 'MEM Vat Sales Book - Entity Information';
        }
    }
    labels
    {
    ...
    begin
        DimensionValue.SetAutoCalcFields(BssiPicture);
    end;
    ...
    var
        ...
        Alicant: Integer;
        TEXT0001: label 'There are more than 10 VAT aliquots.';
        I: Integer;
