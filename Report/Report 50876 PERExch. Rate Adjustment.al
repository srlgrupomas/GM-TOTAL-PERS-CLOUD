...
// ------------------------------------------------------------------------------------------------
report 34006876 "PERExch. Rate Adjustment"
{
    ...
    requestpage
    {
            ...
            area(content)
            {
                group(Options)
                {
                    ...
                    field(BssiDimension; BssiDimension)
                    {
                        ...
                        ToolTip = 'Specifies the entities to restrict the report.';
                        Visible = not MEMDisabled;
                        ...
                        begin
                            ...
                            BssiMEMSingleInstanceCU.BssiSetExchangeRateAdjEntity(BssiDimensionForRestriction);
                        end;
                    ...
                    field(BssiNonMEMDimensionPost; BssiDimensionPosting)
                    {
                        ApplicationArea = Basic, Suite;
                        Caption = 'Dimension Posting';
                        ToolTip = 'Specifies how you want to move dimensions to posted ledger entries.';
                        //ValuesAllowed = "Source Entry Dimensions", "No Dimensions", "G/L Account Dimensions";

                        trigger OnValidate()
                        begin
                            BssiMEMSingleInstanceCU.BssiSetBssiMEMDimensionPosting(BssiDimensionPosting);
                        end;
                    }
                    field(BssiDimensionPost; BssiDimensionPosting)
                    {
                        ObsoleteState = Pending;
                        ObsoleteReason = 'Use BssiNonMEMDimensionPost instead';
                        ApplicationArea = Basic, Suite;
                        Caption = 'Dimension Posting';
                        ToolTip = 'Specifies how you want to move dimensions to posted ledger entries.';
                        Visible = false;
                        //ValuesAllowed = "Bssi Source Entry Dimensions", "Bssi No Dimensions", "Bssi G/L Account Dimensions";
        ...
        begin
            ...
            Bssi_RegKeyValidationMEMReports(MEMDisabled);
            BssiDimensionPosting := BssiDimensionPosting::"Source Entry Dimensions";
            BssiMEMSingleInstanceCU.BssiSetBssiMEMDimensionPosting(BssiDimensionPosting);
            ...
            if BssiDimension <> '' then
                BssiDimensionForRestriction := BssiMEMCoreGlobalCU.Bssi_getEntityFilterString(BssiDimension)//BssiDimension
            else
    ...
    var
        ...
        BssiDimensionPosting: Enum "Exch. Rate Adjmt. Dimensions";
        MEMDisabled: Boolean;
        BssiDimension: Text;
    ...
    var
        ExchRateAdjmtProcess: Codeunit "PERExch. Rate Adjmt. Process";
    begin
