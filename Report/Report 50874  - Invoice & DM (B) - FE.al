report 34006874 "PersInvoice & DM (B) - FE"
{
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './Layout/Report 7107874 - Invoice & DM (B) FE.rdl';
        ...
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(Sales_Invoice_Header___Bill_to_Name_; "Sales Invoice Header"."Sell-to Customer Name")
                    {
                    }
                    column(Sales_Invoice_Header___Bill_to_Address_________Sales_Invoice_Header___Bill_to_City_; "Sales Invoice Header"."sell-to Address" + ' - ' + "Sales Invoice Header"."sell-to City")
                    {
                    }
                    ...
                    column(Sales_Invoice_Header__Sales_Invoice_Header___Bill_to_Customer_No__; "Sales Invoice Header"."sell-to Customer No.")
                    {
                    }
                    ...
                    //SL End
                    // AW - BEGIN TFS 1894
                    column(SalesInvHeader_InvDiscountAmount; "Sales Invoice Header"."Invoice Discount Amount")
                    { }
                    ...
                    { }
                    // AW - END
                    column(ImportePercIIBB; ImportePercIIBB)
                    { }
                    column(TextoImportePercIIBB; TextoImportePercIIBB)
                    { }
                    column(TotalIVA; TotalIVA)
                    { }
                    column(TotalIIBB; TotalIIBB)
                    { }
                    column(TotalOtros; TotalOtros)
                    { }
                    dataitem("Sales Invoice Line"; "Sales Invoice Line")
                    {
                        ...
                        begin
                            ...
                            /*
                            gPrecioIva := ("Sales Invoice Line"."Unit Price" - "Sales Invoice Line"."Line Discount Amount") +
                                          (("Sales Invoice Line"."Unit Price" - "Sales Invoice Line"."Line Discount Amount") *
                                          ("Sales Invoice Line"."VAT %" / 100));
                                          */
                            ...
                            gPrecioIva := ROUND(gPrecioIva, 0.0001);
            ...
            begin
                ...
                Clear(TOTALIVA);
                Clear(TotalOtros);
                VATEntryTotales.Reset();
                VATEntryTotales.SetRange("Document No.", "Sales Invoice Header"."No.");
                VATEntryTotales.SetRange("Document Type", VATEntryTotales."Document Type"::Invoice);
                VATEntryTotales.SetRange("Document Date", "Sales Invoice Header"."Document Date");
                        ...
                        case VATEntryTotales."GMATax Type Loc" of
                            ...
                            VATEntryTotales."GMATax Type Loc"::Otros:
                                if "sales invoice header"."Currency Factor" = 0 then
                                    ...
                                    TotalOtros += abs(VATEntryTotales.Amount * "sales invoice header"."Currency Factor");

                        end;
                    until VATEntryTotales.next() = 0;
                ...
                if recVATEntryAuxPerc.FindFirst() then
                    repeat
                        if "sales invoice header"."Currency Factor" = 0 then
                            ImportePercIIBB += abs(recVATEntryAuxPerc.Amount)
                        else
                            ImportePercIIBB += abs(recVATEntryAuxPerc.Amount * "sales invoice header"."Currency Factor");
                ...
                if "Sales Invoice Header"."Currency Code" <> '' then begin
                    ...
                    //leyenda2 := 'Al solo  efecto impositivo el tipo de cambio aplicado es de $ ' + FORMAT(ROUND(1 / "Currency Factor", 0.01, '=')) +
    ...
    var
        ...
        TotalIIBB: Decimal;
        TotalIVA: Decimal;
        VATEntryTotales: Record "VAT Entry";
}
