...
report 80880 PERDetailTrialBalByEntity
{
    ...
    // 003      20210319            Kuljit      We will not default the entity to the entity filter from system setup as 
    //                                          it is causing the filtering issue when entity filter is empty. Jira: NAVMEM-3092 
    // *********************************************************************************
    DefaultLayout = RDLC;
    RDLCLayout = './Layout/BSSIMEMDetailTrialBalanceByEntity.rdl';
    AdditionalSearchTerms = 'payment due,order status';
    ApplicationArea = Basic, Suite;
    Caption = 'MEM Detail Trial Balance By Entity';
    PreviewMode = PrintLayout;
    UsageCategory = ReportsAndAnalysis;

    dataset
    {
        dataitem(BssiDimenstionValue; "Dimension Value")
        {
            ...
            dataitem("G/L Account"; "G/L Account")
            {
                ...
                column(CompanyName; Empresa.Name)
                {
                }
                ...
                column(BssiTotalByEntityLbl; BssiTotalByEntityLbl + FORMAT(':'))
                {
                }
                ...
                begin
                    ...
                    if BssiMEMSystemSetup.Bssi_iGetGlobalDimensionNoToUse() = 1 then
                        "G/L Account".SetFilter("Global Dimension 1 Filter", BssiDimenstionValue.Code)
                    else
                        "G/L Account".SetFilter("Global Dimension 2 Filter", BssiDimenstionValue.Code);
    ...
    requestpage
    {
        ...
        begin
            ...
            // if BssiDimension = '' then //V17 Fix //003
    ...
    var
        ...
        DetailTrialBalCaptionLbl: Label 'MEM Detail Trial Balance By Entity';
        ...
        BssiTotalByEntityLbl: Label 'Total By';
