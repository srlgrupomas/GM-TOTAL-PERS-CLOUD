...
page 80998 "LOCELEntries Part"
{
        ...
        area(Content)
        {
            repeater(General)
            {
             ...
             ShowCaption = false;
                ...
                field("Client Name"; Rec."PerNombre Cliente")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the name of the client.';
                    Visible = false;
                }
                field("AFIP Voucher Type"; Rec."GMLocPreviewAFIP Inv. Vo. Type")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the AFIP document code for the entry.';
                }
                field("Due Date"; Rec."GMLocPreview Due Date")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the entry''s due date.';
                }
                field("Vat Registration No."; Rec."GMLocPreview CUIT")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the VAT registration number of the entry.';
                }
    ...
    var
     ...
     tablaTemp:Record "G/L Entry" temporary;
    begin
          globalSaveTempMov.GetLastGenJnlLine(tablaTemp);
